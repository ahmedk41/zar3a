        ...
        <div className="bg-white/90 dark:bg-slate-900/80 backdrop-blur-2xl border border-white/50 dark:border-slate-800 rounded-[3.5rem] shadow-2xl p-8 md:p-14 relative overflow-hidden">
          ...
          <header className="mb-8 text-center">
            <h2 className="text-5xl font-[1000] text-slate-900 dark:text-white tracking-tighter">
              {t("reg.title")} <span className="text-emerald-600 dark:text-emerald-500">Zar3a</span>
            </h2>
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 1 && (
              ...
              >
                ...
                <p className="text-center text-slate-400 text-sm font-bold">
                  {t("reg.hasAccount")}{" "}
                  <Link to="/login" className="text-emerald-600 font-black hover:underline">{t("reg.signIn")}</Link>
                </p>
              </motion.div>
            )}
            ...
            {step === 3 && (
              ...
              >
                <p className="text-center text-slate-500 dark:text-slate-400 font-bold text-sm">
                  {t("reg.completeProfile")} <span className="text-emerald-600">{ROLES.find(r => r.id === selectedRole)?.label}</span> {t("reg.profile")}
                </p>
                ...
                {selectedRole === "FARMER" && (
                  <>
                    <Field icon={FiFileText} error={errors3.farmSize}>
                      <input value={farmSize} onChange={e => setFarmSize(e.target.value)} placeholder={t("reg.farmSize")} className="w-full pl-12 pr-5 py-4 rounded-2xl border-2 bg-slate-50/30 dark:bg-slate-950/50 dark:text-white border-slate-100 dark:border-slate-800 focus:border-emerald-500 outline-none font-semibold" />
                    </Field>
                    <Field icon={FiFileText} error={errors3.soilType}>
                      <input value={soilType} onChange={e => setSoilType(e.target.value)} placeholder={t("reg.soilType")} className="w-full pl-12 pr-5 py-4 rounded-2xl border-2 bg-slate-50/30 dark:bg-slate-950/50 dark:text-white border-slate-100 dark:border-slate-800 focus:border-emerald-500 outline-none font-semibold" />
                    </Field>
                    <Field icon={FiMapPin} error={errors3.location}>
                      <input value={location} onChange={e => setLocation(e.target.value)} placeholder={t("reg.location")} className="w-full pl-12 pr-5 py-4 rounded-2xl border-2 bg-slate-50/30 dark:bg-slate-950/50 dark:text-white border-slate-100 dark:border-slate-800 focus:border-emerald-500 outline-none font-semibold" />
                    </Field>
                    <Field icon={FiFileText} error={errors3.sensorId}>
                      <input value={sensorId} onChange={e => setSensorId(e.target.value)} placeholder={t("profile.sensorId") || "Sensor ID"} className="w-full pl-12 pr-5 py-4 rounded-2xl border-2 bg-slate-50/30 dark:bg-slate-950/50 dark:text-white border-slate-100 dark:border-slate-800 focus:border-emerald-500 outline-none font-semibold" />
                    </Field>
                  </>
                )}
                ...
                {selectedRole === "BUYER" && (
                  <div className="text-center py-8 text-slate-500 dark:text-slate-400 font-bold">
                    ...
                    <p className="text-sm mt-2 text-slate-400">{t("reg.buyerContinue")}</p>
                  </div>
                )}
                ...
                {selectedRole === "SUPPLIER" && (
                  <>
                    <Field icon={FiFileText} error={errors3.tradeLicense}>
                      <input value={tradeLicense} onChange={e => setTradeLicense(e.target.value)} placeholder={t("reg.tradeLicense")} className="w-full pl-12 pr-5 py-4 rounded-2xl border-2 bg-slate-50/30 dark:bg-slate-950/50 dark:text-white border-slate-100 dark:border-slate-800 focus:border-emerald-500 outline-none font-semibold" />
                    </Field>
                    <Field icon={FiMapPin} error={errors3.location}>
                      <input value={location} onChange={e => setLocation(e.target.value)} placeholder={t("reg.bizLocation")} className="w-full pl-12 pr-5 py-4 rounded-2xl border-2 bg-slate-50/30 dark:bg-slate-950/50 dark:text-white border-slate-100 dark:border-slate-800 focus:border-emerald-500 outline-none font-semibold" />
                    </Field>
                  </>
                )}
                ...
                {selectedRole === "AGRO_EXPERT" && (
                  <>
                    <Field icon={FiBriefcase} error={errors3.academicDegree}>
                      <input value={academicDegree} onChange={e => setAcademicDegree(e.target.value)} placeholder={t("reg.degree")} className="w-full pl-12 pr-5 py-4 rounded-2xl border-2 bg-slate-50/30 dark:bg-slate-950/50 dark:text-white border-slate-100 dark:border-slate-800 focus:border-emerald-500 outline-none font-semibold" />
                    </Field>
                    <Field icon={FiFileText} error={errors3.experienceYears}>
                      <input value={experienceYears} onChange={e => setExperienceYears(e.target.value)} type="number" min="0" placeholder={t("reg.experience")} className="w-full pl-12 pr-5 py-4 rounded-2xl border-2 bg-slate-50/30 dark:bg-slate-950/50 dark:text-white border-slate-100 dark:border-slate-800 focus:border-emerald-500 outline-none font-semibold" />
                    </Field>
                    <Field icon={FiFileText} error={errors3.bio}>
                      <input value={bio} onChange={e => setBio(e.target.value)} placeholder={t("reg.bio")} className="w-full pl-12 pr-5 py-4 rounded-2xl border-2 bg-slate-50/30 dark:bg-slate-950/50 dark:text-white border-slate-100 dark:border-slate-800 focus:border-emerald-500 outline-none font-semibold" />
                    </Field>
                ...
                <div className="flex gap-3">
                  <motion.button
                    ...
                    disabled={loading}
                    onClick={handleStep3}
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-4 rounded-2xl font-black text-lg shadow-[0_20px_40px_-10px_rgba(16,185,129,0.3)] flex items-center justify-center gap-3 transition-all disabled:opacity-60"
                  >
            ...
            {step === 4 && (
              ...
              >
                ...
                <div>
                  <h3 className="text-3xl font-black text-slate-900 dark:text-white">{t("reg.accountCreated")}</h3>
