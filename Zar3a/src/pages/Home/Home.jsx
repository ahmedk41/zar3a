...
const Home = () => {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 max-w-7xl mx-auto font-sans bg-[#F8FAFC] dark:bg-[#0F172A] min-h-screen">
      ...
      >
        {[
          { icon: <LuActivity />, label: t("home.stat.uptime"),   value: "99.9%",   color: "emerald" },
          { icon: <LuBot />,      label: t("home.stat.aiPred"),   value: "94.2%",   color: "blue" },
          { icon: <LuTrendingUp />, label: t("home.stat.yield"), value: "+28%",    color: "emerald" },
          { icon: <LuShield />,   label: t("home.stat.security"), value: "SSL-Enc", color: "blue" },
        ].map((stat, idx) => (
          <motion.div
            key={idx}
      ...
      <div className="mb-8">
        ...
        >
          ...
          >
            <div className="absolute top-0 end-0 p-8 opacity-10 group-hover:opacity-20 transition-all duration-700 group-hover:scale-110">
              <LuBot size={220} />
            </div>
            <div className="relative z-10 h-full flex flex-col justify-between">
              ...
              <Link to="/chatbot" className="flex items-center gap-2 text-emerald-400 font-black text-lg hover:gap-4 transition-all w-fit">
                {t("home.ai.cta")} <LuArrowRight />
              </Link>
            </div>
          </motion.div>
          ...
          >
            ...
            <Link to="/marketplace" className="font-black text-emerald-700 dark:text-emerald-400 hover:gap-3 transition-all flex items-center gap-2 text-sm mt-4">
              {t("home.store.cta")} <LuArrowRight />
            </Link>
          </motion.div>
