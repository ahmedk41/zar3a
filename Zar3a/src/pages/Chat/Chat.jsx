          ...
          >
            <div className="px-8 py-5 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-slate-900 dark:to-slate-900 space-y-3">
              <div className="flex items-center justify-between">
                <h3 className="font-black text-gray-900 dark:text-white text-sm uppercase tracking-widest">Expert Details</h3>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Specialty</p>
                  <p className="text-sm font-bold text-gray-800 dark:text-white">{expertInfo.specialty || 'N/A'}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-800 dark:text-white">{expertInfo.location || 'N/A'}</p>
                </div>
                <div>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">Email</p>
                  <p className="text-sm font-bold text-gray-800 dark:text-white">{expertInfo.email || 'N/A'}</p>
                </div>
              </div>
              {expertInfo.description && (
                <div>
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider">About</p>
      ...
      <main ref={chatContainerRef} className="flex-1 overflow-y-auto p-8 space-y-8 bg-slate-50/30 dark:bg-slate-950/30 relative">
        ...
        {chatLoading ? (
          <div className="flex flex-col items-center justify-center py-20 space-y-3">
            ...
            <p className="text-sm text-gray-400 font-bold">Loading messages...</p>
          </div>
        ) : (
