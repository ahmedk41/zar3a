      ...
      >
        ...
        >
          <div className="max-w-md text-center md:text-left">
            <h3 className="text-2xl font-black text-slate-900 dark:text-white mb-2 tracking-tight">Join the Zar3a Network</h3>
            <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed">Subscribe for weekly AI insights and agricultural market updates.</p>
          </div>
          <form onSubmit={handleSubscribe} className="w-full md:w-auto flex flex-col sm:flex-row gap-3">
            ...
            >
              {isSubscribing ? <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div> : subscribed ? "Subscribed!" : <>Subscribe <LuArrowRight /></>}
            </button>
          </form>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          {/* Resources */}
          <motion.div variants={itemVariants} className="lg:col-span-2">
            <h3 className="text-slate-900 dark:text-white font-black text-lg mb-6 uppercase tracking-wider">Resources</h3>
            <ul className="space-y-4">
          ...
          <motion.div variants={itemVariants} className="lg:col-span-4">
            <h3 className="text-slate-900 dark:text-white font-black text-lg mb-6 uppercase tracking-wider">Contact & HQ</h3>
        ...
        <motion.div variants={itemVariants} className="pt-8 border-t border-slate-200 dark:border-slate-800 flex flex-col lg:flex-row justify-between items-center gap-6">
          <div className="text-slate-500 dark:text-slate-400 font-bold text-sm text-center">
            © {currentYear} Zar3a System. Built by BIS Team.
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            >
              {theme === "Light" ? (
                <><LuMoon size={16} /> Dark Mode</>
              ) : (
                <><LuSun size={16} /> Light Mode</>
              )}
            </button>
