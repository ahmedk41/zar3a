...
export default function DualImageUpload({ 
  ...
  return (
    <div className="flex flex-col gap-2 w-full mt-1">
      <label className="text-[10px] font-bold text-text-disabled uppercase tracking-widest">{label}</label>
      <div className="flex flex-col md:flex-row items-center gap-4">
        ...
        <div className="flex-1 w-full space-y-3">
          ...
          />
          <div className="relative h-14 flex items-center justify-center border-2 border-dashed border-gray-300 dark:border-slate-600 rounded-2xl hover:bg-primary-light dark:hover:bg-slate-800/50 hover:border-green-500 transition-colors cursor-pointer">
